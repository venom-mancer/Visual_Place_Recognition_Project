#!/bin/bash
# Example script to run threshold analysis for all test datasets

# This script demonstrates how to run comprehensive threshold analysis
# Make sure you have:
# 1. Trained model: logreg_easy_queries_optimal.pkl
# 2. Feature files for all test datasets
# 3. Prediction directories with .txt files
# 4. Inliers directories with .torch files (from full re-ranking)
